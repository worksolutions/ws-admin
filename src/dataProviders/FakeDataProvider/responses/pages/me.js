                ...
                },
                {
                  ...
                  options: {
                    ...
                    actions: {
                      change: {
                        type: "update-context",
                        options: { context: "screen:temp-data.currentUser.firstName" },
                      },
                    },
                  },
                },
                {
                  ...
                  options: {
                    ...
                    actions: {
                      change: {
                        type: "update-context",
                        options: { context: "screen:temp-data.currentUser.surname" },
                      },
                    },
                  },
                },
                {
                  ...
                  options: {
                    ...
                    actions: {
                      change: {
                        type: "update-context",
                        options: { context: "screen:temp-data.currentUser.postName" },
                      },
                    },
                  },
                },
                {
                  ...
                  options: {
                    ...
                    actions: {
                      change: {
                        type: "update-context",
                        options: { context: "screen:temp-data.currentUser.email" },
                      },
                    },
                  },
                },
                {
                  ...
                  options: {
                    ...
                    actions: {
                      change: {
                        type: "update-context",
                        options: { context: "screen:temp-data.currentUser.blocked" },
                      },
                    },
                  },
                },
